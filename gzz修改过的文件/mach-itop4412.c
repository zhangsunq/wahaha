...
struct soc_camera_device ov5640_plat = {
		.user_width =1920, //1280,//640,
		.user_height = 1080,//480,
};
...
/* add by cym 20140124 */
#ifdef CONFIG_VIDEO_OV5640_MIPI
struct soc_camera_device ov5640_plat_mipi = {
		.user_width =1920, //1280,//640,
		.user_height = 1080,//480,
};
static struct i2c_board_info  ov5640_i2c_info_mipi = {
	I2C_BOARD_INFO("ov5640_mipi", 0x78>>1),
	.platform_data = &ov5640_plat_mipi,
};
...
static struct s3c_platform_camera ov5640_mipi = {
		...
		.fmt		= MIPI_CSI_YCBCR422_8BIT,
		.order422	= CAM_ORDER422_8BIT_CBYCRY,
		.info		= &ov5640_i2c_info_mipi,
		.pixelformat	= V4L2_PIX_FMT_YUYV, //modify by cym V4L2_PIX_FMT_UYVY,
		.srclk_name = "xusbxti",////DAI DING
		.clk_rate	= 96000000,
		.line_length	= 1920,
